...
class BaseDbConnector:
    ...
    def open_connection(self):
        raise NotImplementedError(f'open_connection is not implemented')

    def cursor(self):
        raise NotImplementedError(f'cursor is not implemented')

    def close_connection(self):
        raise NotImplementedError(f'close_connection is not implemented')
